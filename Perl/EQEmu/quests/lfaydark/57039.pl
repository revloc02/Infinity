...
# Description:			Random Roam - 57039 = brownie_scout
# ==============================================================
...
# constants
use constant MINIMUM_PAUSE_SECONDS => 20; # the minimum pause between movements
use constant PAUSE_RANGE_SECONDS => 90; # random pause range between movements
use constant X_ROAM_DISTANCE => 200;
use constant Y_ROAM_DISTANCE => 40;
