...
# constants
use constant MINIMUM_PAUSE_SECONDS => 45; # the minimum pause between movements
use constant PAUSE_RANGE_SECONDS => 45; # random pause range between movements
use constant X_ROAM_DISTANCE => 500;
use constant Y_ROAM_DISTANCE => 500;
